        ...
        init : function(ed, url) {
            ...
            ed.onBeforeSetContent.add(function(ed, o) {
				...
				while((running == true) && (o.content.indexOf(startTag) != -1)){
					...
					if(endPos != -1){
						...
						if(o.content.lastIndexOf('<', startPos-1) > o.content.lastIndexOf('>', startPos-1))
						{
							o.content = o.content.substr(0, startPos) + '&lt;!--CODE' + 
								encodedPHPCode + 'CODE--&gt;' + 
            ...
            ed.onPostProcess.add(function(ed, o) { 
                if (o.get) { 
					...
					while((altrunning == true) && (o.content.indexOf(altstartTag) != -1)){
