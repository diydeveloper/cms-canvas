$(document).ready( function() {
    ...
    $('.choose_image').click( function() {
        ...
        window.KCFinder = {
            callBack: function(url) {
                ...
                $.post(ADMIN_URL + '/content/entry/create-thumbnail', {'image_path': url, _token: $('meta[name="csrf-token"]').attr('content')}, function(image_path) {
    ...
    $('.remove_image').click( function() {
        var link = $(this);
        $.post(ADMIN_URL + '/content/entry/create-thumbnail', {'image_path': ' ', _token: $('meta[name="csrf-token"]').attr('content')}, function(image_path) {
            link.parent().find('.image_thumbnail').attr('src', image_path);
        });
