    ...
    jq_admin_toolbar('.cc_image_editable').live('click', function() {
        ...
        window.KCFinder = {
            callBack: function(url) {
                ...
                jq_admin_toolbar.post(ADMIN_URL + '/content/entry/pre-process-inline-content', {'editable_id': editable_id, 'content': url}, function(response) {
        ...
        window.open(ADMIN_ASSETS + '/js/kcfinder/browse.php?type=images',
