<div style="width: 150px; text-align: center; float: left;">
    <a class="choose_image" href="javascript:void(0);" style="display: block; margin-bottom: 5px;">
        <img class="image_thumbnail" src="{!! Content::thumbnail(old($fieldType->getKey(), $fieldType->getData()), ['width' => 150, 'height' => 150, 'no_image' => Theme::asset('images/no_image.jpg')]) !!}" />
    </a>
    ...
    {!! Form::hidden($fieldType->getKey(), $fieldType->getData(), ['class' => 'hidden_file']) !!}
</div>
