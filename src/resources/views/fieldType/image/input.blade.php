<div style="width: 150px; text-align: center; float: left;">
    <a class="choose_image" href="javascript:void(0);" style="display: block; margin-bottom: 5px;">
        <img class="image_thumbnail" src="{!! Content::thumbnail(Input::old($fieldType->getKey(), $fieldType->data), ['width' => 150, 'height' => 150, 'no_image' => Theme::asset('images/no_image.jpg')]) !!}" />
    </a>
