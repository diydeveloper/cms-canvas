<div class="box">
    ...
    <div class="content">
                    ...
                    @if (count($users) > 0)
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ (empty($user->last_login)) ? '' : $user->last_login->format('M j, Y h:i a') }}</td>
        ...
        <div class="pagination_footer">
            ...
            <div class="results">Showing {{ $users->getFrom() }} to {{ $users->getTo() }} of {{ $users->getTotal() }} ({{ $users->getLastPage() }}  Pages)</div>
        </div>
    </div>
</div>
