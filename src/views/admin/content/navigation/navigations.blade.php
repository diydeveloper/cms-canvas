<div class="box">
    ...
    <div class="content">
        ...
        <div class="pagination_footer">
            <div class="links">{{ $navigations->links() }}</div>
            <div class="results">Showing {{ $navigations->getFrom() }} to {{ $navigations->getTo() }} of {{ $navigations->getTotal() }} ({{ $navigations->getLastPage() }}  Pages)</div>
        </div>
    </div>
</div>
