...
Route::group(['prefix' => Admin::getUrlPrefix(), 'middleware' => ['cmscanvas.auth', 'cmscanvas.permission'], 'permission' => 'ADMIN'], function()
{
    ...
    Route::get('dashboard', ['as' => 'admin.dashboard', 'uses' => 'CmsCanvas\Http\Controllers\Admin\DashboardController@getDashboard']);
    ...
    Route::group(['prefix' => 'user'], function()
    {
        ...
        {
            Route::get('/', ['as' => 'admin.user.users', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@getUsers']);
            Route::post('/', ['as' => 'admin.user.users.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@postUsers']);

            Route::post('delete', ['as' => 'admin.user.delete.post', 'permission' => 'ADMIN_USER_DELETE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@postDelete']);

            Route::get('add', ['as' => 'admin.user.add', 'permission' => 'ADMIN_USER_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@getEdit']);
            Route::post('add', ['as' => 'admin.user.add.post', 'permission' => 'ADMIN_USER_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@postEdit']);

            Route::get('{user}/edit', ['', 'as' => 'admin.user.edit', 'permission' => 'ADMIN_USER_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@getEdit']);
            Route::post('{user}/edit', ['as' => 'admin.user.edit.post', 'permission' => 'ADMIN_USER_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\UserController@postEdit']);
        });

        Route::group(['prefix' => 'permission', 'permission' => 'ADMIN_PERMISSION_VIEW'], function()
        {

            Route::get('/', ['as' => 'admin.user.permission.permissions', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\PermissionController@getPermissions']);
            Route::post('/', ['as' => 'admin.user.permission.permissions.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\PermissionController@postPermissions']);

            Route::post('delete', ['as' => 'admin.user.permission.delete.post', 'permission' => 'ADMIN_PERMISSION_DELETE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\PermissionController@postDelete']);

            Route::get('add', ['as' => 'admin.user.permission.add', 'permission' => 'ADMIN_PERMISSION_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\PermissionController@getEdit']);
        ...
        Route::group(['prefix' => 'role', 'permission' => 'ADMIN_ROLE_VIEW'], function()
        {
            ...
            Route::get('/', ['as' => 'admin.user.role.roles', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\RoleController@getRoles']);
            Route::post('/', ['as' => 'admin.user.role.roles.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\RoleController@postRoles']);

            Route::post('delete', ['as' => 'admin.user.role.delete.post', 'permission' => 'ADMIN_ROLE_DELETE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\RoleController@postDelete']);

            Route::get('add', ['as' => 'admin.user.role.add', 'permission' => 'ADMIN_ROLE_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\User\RoleController@getEdit']);
    ...
    Route::group(['prefix' => 'content'], function()
    {
        Route::group(['prefix' => 'navigation', 'permission' => 'ADMIN_NAVIGATION_VIEW'], function()
        {
            ...
            Route::get('/', ['as' => 'admin.content.navigation.navigations', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\NavigationController@getNavigations']);
            Route::post('/', ['as' => 'admin.content.navigation.navigations.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\NavigationController@postNavigations']);

            Route::get('add', ['as' => 'admin.content.navigation.add', 'permission' => 'ADMIN_NAVIGATION_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\NavigationController@getEdit']);
            Route::post('add', ['as' => 'admin.content.navigation.add.post', 'permission' => 'ADMIN_NAVIGATION_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\NavigationController@postEdit']);
        ...
        Route::group(['prefix' => 'entry', 'permission' => 'ADMIN_ENTRY_VIEW'], function()
        {
            ...
            Route::get('/', ['as' => 'admin.content.entry.entries', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\EntryController@getEntries']);
        ...
        Route::group(['prefix' => 'type'], function()
        {
            ...
            {
                Route::get('/', ['as' => 'admin.content.type.types', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\TypeController@getTypes']);
                Route::post('/', ['as' => 'admin.content.type.types.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\TypeController@postTypes']);
            ...
            Route::group(['prefix' => '{contentType}/field', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_VIEW'], function()
            {
                ...
                Route::get('/', ['as' => 'admin.content.type.field.fields', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@getFields']);
                Route::post('/', ['as' => 'admin.content.type.field.fields.post', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postFields']);

                Route::post('delete', ['as' => 'admin.content.type.field.delete.post', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_DELETE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postDelete']);

                Route::get('add', ['as' => 'admin.content.type.field.add', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@getEdit']);
                Route::post('add', ['as' => 'admin.content.type.field.add.post', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_CREATE', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postEdit']);

                Route::get('{contentTypeField}/edit', ['as' => 'admin.content.type.field.edit', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@getEdit']);
                Route::post('{contentTypeField}/edit', ['as' => 'admin.content.type.field.edit.post', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postEdit']);

                Route::post('order', ['as' => 'admin.content.type.field.order.post', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postOrder']);
                Route::post('settings', ['as' => 'admin.content.type.field.settings.post', 'permission' => 'ADMIN_CONTENT_TYPE_FIELD_EDIT', 'uses' => 'CmsCanvas\Http\Controllers\Admin\Content\Type\FieldController@postSettings']);
